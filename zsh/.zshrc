...
function zle-keymap-select {
  case $KEYMAP in
    ...
    viins|main) echo -ne '\e[6 q' ;;  # bar cursor
  esac
}
zle -N zle-keymap-select

# Also set cursor correctly on startup
...
bindkey '^E' autosuggest-execute     # Ctrl+E = accept + run immediately
